...
public class TheMovieDBController {
	...
	public ResponseEntity<Object> addFilm(@RequestBody FilmRicevutoDaAngular filmRicevutoDaAngular) { // finito
	...
	public ResponseEntity<Object> addCoupon(@RequestBody CouponRicevutoDaAngular id) {//da finire
